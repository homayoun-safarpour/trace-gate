...
- [agent-loop-engine](https://github.com/homayoun-safarpour/agent-loop-engine) - consume exit 0/2 as a repair gate
- [judge-field-guide](https://github.com/homayoun-safarpour/judge-field-guide) - CI-tested map of the LLM-judge ecosystem
- [judge-drift-sentinel](https://github.com/homayoun-safarpour/judge-drift-sentinel) - judge vs system drift sibling gate
